                    ...
                    <div className="way light-theme">
                        <p className="item-way light-theme">
                            ...
                            <a href="" className="sniker light-theme">
                                Nike Air Jordan 5 Retro X Of White
                            </a>
                        </p>
                    </div>
                    <div className="cardo">
                        <div className="item_card">
                            <div className="title_card">
                                <h1 className="main_h1 bebra">Nike Air Jordan 5 Retro X Of White</h1>
                            </div>
                            <div className="bigos">
                                <div className="column1">
                                    <div className="product-gallery">
                                        <div className="thumbnails">
                                            <img
                                                src="https://static1.s123-cdn-static-a.com/uploads/6954727/800_63ae9835b5f23.jpg"
                                                alt="Product Image1"
                                                data-image="https://static1.s123-cdn-static-a.com/uploads/6954727/800_63ae9835b5f23.jpg"
                                                className="thumbnail active"
                                            />
                                            <img
                                                src="https://static1.s123-cdn-static-a.com/uploads/6954727/2000_63ae983c04c85.jpg"
                                                alt="Product Image2"
                                                data-image="https://static1.s123-cdn-static-a.com/uploads/6954727/2000_63e4b7cde55b6.jpg"
                                                className="thumbnail"
                                            />
                                            <img
                                                src="https://static1.s123-cdn-static-a.com/uploads/6954727/2000_63ae984156aa5.jpg"
                                                alt="Product Image3"
                                        ...
                                        <div className="main-image">
                                            <img
                                                src="https://static1.s123-cdn-static-a.com/uploads/6954727/2000_63ae9835b5f23.jpg"
                                                alt="Product Image1"
                                                className="image"
                                                data-image="img1.jpg"
                                            />
