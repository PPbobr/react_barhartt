                    ...
                    <div className="way light-theme">
                        <p className="item-way light-theme">
                            ...
                            <a href="" className="sniker light-theme">
                                ADIDAS X BAD BUNNY FORUM LOW NEGRO
                            </a>
                        </p>
                    </div>
                    <div className="cardo">
                                ...
                                <div className="column1">
                                    <div className="product-gallery">
                                        <div className="thumbnails">
                                            <img
                                                src="https://static1.s123-cdn-static-a.com/uploads/6954727/2000_63831dd026cea.jpg"
                                                alt="Product Image1"
                                                data-image="https://static1.s123-cdn-static-a.com/uploads/6954727/800_63ae9835b5f23.jpg"
                                                className="thumbnail active"
                                            />
                                            <img
                                                src="https://static1.s123-cdn-static-a.com/uploads/6954727/2000_63831cd89b0e1.jpg"
                                                alt="Product Image2"
