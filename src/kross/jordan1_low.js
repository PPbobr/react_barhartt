                    ...
                    <div className="way light-theme">
                        <p className="item-way light-theme">
                            ...
                            <a href="" className="sniker light-theme">
                                NIKE AIR JORDAN 1 LOW X TRAVIS
                            </a>
                        </p>
                    </div>
                    <div className="cardo">
                        <div className="item_card">
                            <div className="title_card">
                                <h1 className="main_h1 bebra">NIKE AIR JORDAN 1 LOW X TRAVIS</h1>
                            </div>
                            <div className="bigos">
                                <div className="column1">
                                    <div className="product-gallery">
                                        <div className="thumbnails">
                                            <img
                                                src="https://static1.s123-cdn-static-a.com/uploads/6954727/2000_64039a31ede26.jpg"
                                                alt="Product Image1"
                                                data-image="https://static1.s123-cdn-static-a.com/uploads/6954727/800_63e4b7dfd6d1d.jpg"
                                                className="thumbnail active"
                                            />
                                            <img
                                                src="https://static1.s123-cdn-static-a.com/uploads/6954727/2000_6403999c0fa83.jpg"
                                                alt="Product Image2"
                                                data-image="https://static1.s123-cdn-static-a.com/uploads/6954727/2000_63e4b7cde55b6.jpg"
                                                className="thumbnail"
                                            />
                                            <img
                                                src="https://static1.s123-cdn-static-a.com/uploads/6954727/2000_64039929795be.jpg"
                                                alt="Product Image3"
                                ...
                                <div className="column2">
                                    ...
                                    <hr className="gray" />
                                    <div className="price">
                                        <h1 className="cpt-price">2740₴</h1>
                                        <p className="desc">
