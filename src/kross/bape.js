                    ...
                    <div className="cardo">
                        <div className="item_card">
                            <div className="title_card">
                                <h1 className="main_h1 bebra">A BATHING APE BAPE STA LOW</h1>
                            </div>
                            <div className="bigos">
                                <div className="column1">
                                    <div className="product-gallery">
                                        <div className="thumbnails">
                                            <img
                                                src="https://static1.s123-cdn-static-a.com/uploads/6954727/2000_641fdd00a708a.jpg"
                                                alt="Product Image1"
                                                data-image="https://static1.s123-cdn-static-a.com/uploads/6954727/800_63e4b7dfd6d1d.jpg"
                                                className="thumbnail active"
                                            />
                                            <img
                                                src="https://static1.s123-cdn-static-a.com/uploads/6954727/2000_641fdd080ea34.jpg"
                                                alt="Product Image2"
                                                data-image="https://static1.s123-cdn-static-a.com/uploads/6954727/2000_63e4b7cde55b6.jpg"
                                                className="thumbnail"
                                            />
                                            <img
                                                src="https://static1.s123-cdn-static-a.com/uploads/6954727/2000_641fdd0cd75f3.jpg"
                                                alt="Product Image3"
                                ...
                                <div className="column2">
                                    ...
                                    <hr className="gray" />
                                    <div className="price">
                                        <h1 className="cpt-price">3280₴</h1>
                                        <p className="desc">
