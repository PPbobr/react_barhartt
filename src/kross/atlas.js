                        ...
                        <div className="item_card">
                            ...
                            <div className="bigos">
                                <div className="column1">
                                    <div className="product-gallery">
                                        <div className="thumbnails">
                                            <img
                                                src="https://static1.s123-cdn-static-a.com/uploads/6954727/2000_6368254a0d0a4.jpg"
                                                alt="Product Image1"
                                                data-image="https://static1.s123-cdn-static-a.com/uploads/6954727/800_63ae9835b5f23.jpg"
                                                className="thumbnail active"
                                            />
                                            <img
                                                src="https://static1.s123-cdn-static-a.com/uploads/6954727/2000_63682552a4935.jpg"
                                                alt="Product Image2"
                                ...
                                <div className="column2">
                                    ...
                                    <hr className="gray" />
                                    <div className="price">
                                        <h1 className="cpt-price">2180₴</h1>
                                        <p className="desc">
                        ...
                        <div className="main_cont_kross">
                            <div className="main_kross new-block" data-category="nike">
                                ...
                                <div className="kross_box">
                                    ...
                                    <h1 className="price_kross">2180₴</h1>
                                </div>
                            </div>
